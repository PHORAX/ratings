...
class tx_ratings_pi1_wizicon {
	...
	function proc($wizardItems)	{
		...
		$wizardItems['plugins_tx_ratings_pi1'] = array(
			'icon'=>\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('ratings').'pi1/ce_wiz.gif',
	...
	function includeLocalLang()	{
		$llFile = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('ratings').'locallang.xml';
